...
In that case, the work may be done on the solution owner's behalf by a **certified UniVERSE / TrueAI / UniCORE-AI expert** — an external practitioner who is fluent in the Foundation, the Layered CORE Model, and the programme's published commitments, who **holds a current Solution Review certificate issued by Unitek Systems Limited**, and who provides Solution Review as a service. The certified expert may be at any career stage, including a university student or junior consultant; what matters is the certificate, the fluency, and the direct working relationship with the solution owner, not the expert's seniority. The five-step process does not change. What changes is who sits on the human side of the pairing, and what the solution owner must still supply.

**The certified expert works directly with one human who owns, or knows everything about, the solution being reviewed.** That is the pairing the review depends on. The solution owner (or the human who carries the institutional memory) remains in the loop throughout; the certified expert operates the Claw on their behalf, not in their absence. Without that direct working relationship, the review collapses to a surface reading of the solution's written documentation, which is not what a Solution Review is for ([§6.2](#62-the-undocumented-is-what-matters)).
